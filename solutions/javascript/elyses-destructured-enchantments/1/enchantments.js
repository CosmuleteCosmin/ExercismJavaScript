 ...
 */
export function shiftThreeCardsAround([firsCard, secondCard, thirdCard]) {
  return [secondCard, thirdCard, firsCard];
}
 ...
 */
export function swapNamedPile({disregarded, chosen}) {
